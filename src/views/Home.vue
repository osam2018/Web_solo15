<template>
    <el-container>
        <el-aside width="400px" style="height : 1010px">
            <el-table
                    :data="tableData1"
                    style="width: 100%">
                <el-table-column
        ...
        <el-main>
            ...
            <ol align="left">
                ...
                <li>Review</li>
                <p>
                    2시간 정도 걸려 휘리릭 다 읽고는 눈이 약간 아팠지만 그 만큼 흡입력이 있는 책이고 집중해서 다 읽고 나니 기분도 좋았다. 다른 일본 추리 소설과 다르게 괜찮았던 점은 책을 두세권으로 나눠서 출간하지 않은 것이다. 우리나라에만 번역해서 들어오면 책 팔아먹으려고 늘리는 걸 보면 짜증이 났는데 말이다. 결말은 나른 추리소설들과 비슷했다. 범인은 예상과 다른 반전인물이었다는 것. 훈훈한 마무리라는 점도. 앞으로 고민이 있을 때 이런 한권짜리 추리 소설을 읽어야 겠다고 생각했다. 빨려들어갈 것처럼 빠져 읽을 수 있으니 그 시간만큼은 다른 고민을 하지 않고 쉴 수 있으니 말이다. 이번 책은 발췌가 없다.
                </p>
            </ol>
        </el-main>
    </el-container>
        ...
        data() {
            return {
                tableData1: [{
                    ...
                    rank: '15',
                    name: '디즈니의 악당들. 1: 사악한 여왕'
                }, {
                    rank: '16',
                    name: '내 이름은 빨강. 1(모던 클래식 1)'
                }, {
                    rank: '17',
                    name: '왜 나는 너를 사랑하는가'
                }, {
