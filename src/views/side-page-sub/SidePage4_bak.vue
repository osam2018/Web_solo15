<template>
    <el-main >
        ...
        <br><br>
        <el-button-group>
            <el-button type="primary" icon="el-icon-arrow-left" @click="handleSelect('sidepage3')">Prev Page</el-button>
            <el-button type="primary" @click="handleSelect('sidepage1')">Next Page<i class="el-icon-arrow-right el-icon-right"></i></el-button>
        </el-button-group>
