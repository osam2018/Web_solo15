<template>
    <el-container>
        ...
        <el-main>
            <router-view/>
            <div id="bookimage"><img src="../../assets/soci.jpg" style="float:left;padding-top:40px;padding-left:40px;width:230px;height:260px;"></div>
            <el-table
                    :data="info2.tableData2"
...
<script lang="ts">
    ...
    @Component
    export default class DashBoard2 extends Vue{
        public $http:any;
        private info1:String[] = [];
        private info2:String[] = [];
        async mounted(){
            let result1 = await this.$http.get("./mockup_data/Table5.json");
            let result2 = await this.$http.get("./mockup_data/Table6.json")
            this.info1 = result1.data;

            this.info2 = result2.data;
