<template>
    <el-container>
        ...
        <el-main>
            <router-view/>
            <div id="bookimage"><img src="../../assets/micro.jpg" style="float:left;padding-top:40px;padding-left:40px"></div>
            <el-table
...
<script lang="ts">
    ...
    export default class DashBoard2 extends Vue{
        ...
        async mounted(){
            let result1 = await this.$http.get("./mockup_data/Table3.json");
            let result2 = await this.$http.get("./mockup_data/Table4.json")
            this.todo = result1.data;
