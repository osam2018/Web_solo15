<template>
    <el-container>
        ...
        <el-main>
            <router-view/>
            <div id="bookimage"><img src="../../assets/sci.jpg" style="float:left;padding-top:40px;padding-left:40px;width:230px;height:260px;"></div>
            <el-table
...
<script lang="ts">
    ...
    export default class DashBoard{
        ...
        async mounted(){
            let result1 = await this.$http.get("./mockup_data/Table7.json");
            let result2 = await this.$http.get("./mockup_data/Table8.json")
